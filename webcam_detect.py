...
# Added 20210329 to fix get session not found
import tensorflow.python.keras.backend as KV1
...
class YOLO(object):
    _defaults = {
        ...
        "classes_path": 'model_data/combined_classes.txt',
        "score": 0.3,
        "iou": 0.45,
    ...
    def __init__(self, **kwargs):
        ...
        # 20210329 Using KV1 instead
        self.sess = KV1.get_session()
